...
class JFP:
  ...
  clampedSubductionEast = maxSubductionDepth * \
      math.tan(plateAngle / 180 * math.pi)
  ...
  def leadingEdgeLongitude(date):   # date of YHS (ma)
    ...
    plateLongitudeCoverage = gh.longitudeFromDistE(
        JFP.trackingLatitude, plateMotionEast)
