...
from .pnw_rotation_py_dialog import PnwRotPyDialog
import os.path
...
class PnwRotPy:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Pnw Rotation ')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PnwRotPy', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/pnw_rotation_py/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'PNW Rotation '),
            callback=self.run,
